...
#
# Generated by Vivado on Wed Jul 08 15:37:32 +07 2026
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  # Create instance: proc_sys_reset_periph, and set properties
  set proc_sys_reset_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_periph ]
  ...
  connect_bd_net -net clk_wiz_1_clk_out4 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins proc_sys_reset_periph/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_periph/dcm_locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked] [get_bd_pins rst_clk_wiz_1_100M_sdram/dcm_locked]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports ext_reset_in_0] [get_bd_pins proc_sys_reset_periph/ext_reset_in] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in] [get_bd_pins rst_clk_wiz_1_100M_sdram/ext_reset_in]
  connect_bd_net -net mdm_1_Interrupt [get_bd_pins mdm_1/Interrupt] [get_bd_pins microblaze_0_xlconcat/In0]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_periph/mb_debug_sys_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst] [get_bd_pins rst_clk_wiz_1_100M_sdram/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
  connect_bd_net -net proc_sys_reset_periph_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins proc_sys_reset_periph/peripheral_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port GPIO_0 -pg 1 -lvl 7 -x 2210 -y 1000 -defaultsOSRD
preplace port QSPI_0_0 -pg 1 -lvl 7 -x 2210 -y 800 -defaultsOSRD
preplace port UART_0 -pg 1 -lvl 7 -x 2210 -y 650 -defaultsOSRD
preplace port sdram_0 -pg 1 -lvl 7 -x 2210 -y 1140 -defaultsOSRD
preplace port clk_in1_0 -pg 1 -lvl 0 -x 0 -y 450 -defaultsOSRD
preplace port ext_reset_in_0 -pg 1 -lvl 0 -x 0 -y 550 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 6 -x 2040 -y 1000 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 5 -x 1660 -y 300 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 6 -x 2040 -y 810 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 6 -x 2040 -y 490 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 6 -x 2040 -y 660 -defaultsOSRD
preplace inst clk_wiz_1 -pg 1 -lvl 1 -x 110 -y 450 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 3 -x 790 -y 1020 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -x 1210 -y 230 -defaultsOSRD
preplace inst microblaze_0_axi_intc -pg 1 -lvl 3 -x 790 -y 790 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 5 -x 1660 -y 90 -defaultsOSRD
preplace inst microblaze_0_xlconcat -pg 1 -lvl 2 -x 420 -y 1010 -defaultsOSRD
preplace inst rst_clk_wiz_1_100M -pg 1 -lvl 2 -x 420 -y 300 -defaultsOSRD
preplace inst rst_clk_wiz_1_100M_sdram -pg 1 -lvl 4 -x 1210 -y 530 -defaultsOSRD
preplace inst sdram_axi_0 -pg 1 -lvl 6 -x 2040 -y 1140 -defaultsOSRD
preplace inst proc_sys_reset_periph -pg 1 -lvl 2 -x 420 -y 540 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -x 1660 -y 650 -defaultsOSRD
preplace netloc M00_ARESETN_1 1 4 2 1460 1160 NJ
preplace netloc axi_quad_spi_0_ip2intc_irpt 1 1 6 210 910 NJ 910 NJ 910 NJ 910 1870J 900 2170
preplace netloc axi_timer_0_interrupt 1 1 6 240 1100 640J 930 NJ 930 NJ 930 1910J 920 2190
preplace netloc axi_uartlite_0_interrupt 1 1 6 240 920 NJ 920 NJ 920 NJ 920 1900J 910 2180
preplace netloc clk_in1_0_1 1 0 1 NJ 450
preplace netloc clk_wiz_1_clk_out2 1 1 5 NJ 430 NJ 430 980 430 1490 1140 NJ
preplace netloc clk_wiz_1_clk_out3 1 1 5 220 650 NJ 650 NJ 650 1470J 870 1850J
preplace netloc clk_wiz_1_locked 1 1 3 230 640 NJ 640 970
preplace netloc ext_reset_in_0_1 1 0 4 NJ 550 210 440 NJ 440 950
preplace netloc mdm_1_Interrupt 1 1 3 230 1110 NJ 1110 950
preplace netloc mdm_1_debug_sys_rst 1 1 3 240 670 NJ 670 980
preplace netloc microblaze_0_Clk 1 1 4 200 410 630 410 980 410 1510
preplace netloc microblaze_0_intr 1 2 1 620 800n
preplace netloc rst_clk_wiz_1_100M_bus_struct_reset 1 2 3 600 120 NJ 120 NJ
preplace netloc rst_clk_wiz_1_100M_mb_reset 1 2 2 640 260 N
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 2 3 NJ 340 930J 130 1480
preplace netloc clk_wiz_1_clk_out4 1 1 5 200 680 600 660 NJ 660 1500 880 1880
preplace netloc proc_sys_reset_periph_peripheral_aresetn 1 2 4 610 680 NJ 680 1510 890 1890
preplace netloc microblaze_0_debug 1 3 1 960 220n
preplace netloc microblaze_0_interrupt 1 3 1 940 200n
preplace netloc axi_quad_spi_0_SPI_0 1 6 1 NJ 800
preplace netloc microblaze_0_M_AXI_IC 1 4 1 1470 230n
preplace netloc axi_gpio_0_GPIO 1 6 1 NJ 1000
preplace netloc axi_interconnect_0_M00_AXI 1 5 1 1840 300n
preplace netloc microblaze_0_M_AXI_DC 1 4 1 1460 210n
preplace netloc axi_uartlite_0_UART 1 6 1 NJ 650
preplace netloc sdram_axi_0_sdram 1 6 1 NJ 1140
preplace netloc microblaze_0_ilmb_1 1 4 1 1450 80n
preplace netloc microblaze_0_dlmb_1 1 4 1 1440 60n
preplace netloc microblaze_0_M_AXI_DP 1 4 1 1450 230n
preplace netloc microblaze_0_axi_periph_M00_AXI 1 2 4 650 900 NJ 900 NJ 900 1820
preplace netloc microblaze_0_axi_periph_M01_AXI 1 5 1 1830 440n
preplace netloc microblaze_0_axi_periph_M02_AXI 1 5 1 N 640
preplace netloc microblaze_0_axi_periph_M03_AXI 1 5 1 1870 660n
preplace netloc microblaze_0_axi_periph_M04_AXI 1 2 4 650 940 NJ 940 NJ 940 1810
preplace netloc microblaze_0_axi_periph_M05_AXI 1 5 1 1860 700n
levelinfo -pg 1 0 110 420 790 1210 1660 2040 2210
pagesize -pg 1 -db -bbox -sgen -150 0 2320 1220
"
}
