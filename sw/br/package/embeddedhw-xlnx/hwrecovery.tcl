if {[llength $argv] != 3} {
    puts "ERROR: Ожидается 4 аргумента:"
    puts "  1. PRJ_VIVADO_PATH (путь к директории проекта)"
    puts "  2. NAME_BD         (имя Block Design)"
    puts "  3. HW_SPEC_PATH (куда экспортировать .hdf/.xsa)"
    exit 1
}
lassign $argv pth_hw_prj name_bd pth_export_hdf
# set pth_hw_prj $env(PRJ_VIVADO_PATH)
